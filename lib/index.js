...
internals.Connection.prototype.start = function () {
    ...
    return new Promise((resolve, reject) => {
        ...
        if (this.settings.clusterNodes && this.settings.clusterNodes.length) {
            options.clusterNodes = this.settings.clusterNodes;
            options.clusterOpts = this.settings.clusterOpts || {};
            client = new Redis.Cluster(options.clusterNodes, options.clusterOpts);
        }
        else if (this.settings.sentinels && this.settings.sentinels.length) {
