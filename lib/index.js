...
internals.Connection.prototype.start = function () {
    ...
    return new Promise((resolve, reject) => {
        ...
        //     client = new Redis(this.settings.url);
        // }
        // else {
        //     if (this.settings.sentinels && this.settings.sentinels.length) {
        //         this.settings.name = this.settings.sentinelName;
        //     }
        //     else if (this.settings.socket) {
        //         this.settings.path = this.settings.socket;
        //     }
        ...
        if (this.settings.sentinels && this.settings.sentinels.length) {
            ...
            // send all parameters to ioredis
            if (!this.settings.db) {
                this.settings.db = this.settings.database;
            };
            client = new Redis(this.settings);
        }
